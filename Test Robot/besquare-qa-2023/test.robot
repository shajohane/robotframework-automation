...
Check Swap Charge
    ...
    #  Convert To Integer    ${expected_swap}
     ${val}=    Format String    {:,.0f}    ${expected_swap}
     Element Text Should Be    //*[text()="USD"]//preceding-sibling::div     ${val}
...
Check Deriv Life
    ...
    Switch Window    Deriv Life
    Wait Until Page Contains    Making an impact that matters    10
